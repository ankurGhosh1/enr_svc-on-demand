...
urlpatterns = [
    ...
    path('services/callback/<slug:slug>', Callback.as_view(), name='callback'),
    ...
    path('review/job/<int:job_id>/user/<int:applier_id>',views.indiJob,name = 'indiJob'),
    path('hire/<int:job_id>/<int:applier_id>',views.hire,name = 'hire'),
